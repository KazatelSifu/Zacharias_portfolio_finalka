...
export const VuesaxBoldSms1 = ({ className }) => {
  return (
    <svg
      className={`vuesax-bold-sms-1 ${className}`}
      fill="none"
      height="32"
      viewBox="0 0 32 32"
      width="32"
